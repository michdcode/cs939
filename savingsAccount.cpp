...
int main()
{
	...
	double startingBal, annualIntRate, currentBal, monthlyIntRate, totalDeposits, totalWithdrawls, 
		   totalIntEarned, monthlyStartingBal;
	...
	startingBal = monthlyStartingBal;
	...
	{	// Gather & validate deposits, add to deposit totals & add to current balance
		...
		while (monthlyWithdrawl < 0 || > currentBal)
		{
		...
		monthlystart = currentBal;
	}
	// Create table to display results
	cout << endl;
	cout << left << set(35) << "Starting Balance: $"
		 << right << startingBal << endl;
	cout << left << set(35) << "Total Deposits: $"
		 << right << totalDeposits << endl;
	cout << left << set(35) << "Total Withdrawls: $"
		 << right << totalWithdrawls << endl;
	cout << left << set(35) << "Total Interest Earned: $"
		 << right << totalIntEarned << endl;
	cout << left << set(35) << "Final Balance: $"
